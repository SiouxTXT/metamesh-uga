...
ALTER TABLE tools ADD COLUMN IF NOT EXISTS capabilities TEXT;
...
INSERT INTO d1_migrations (name, applied_at) VALUES ('004_trust_and_lifecycle.sql', CURRENT_TIMESTAMP);
